...
exports.help = {
  name: "addrole",
  category: "Mods",
  description: "Add role to specified member `(My role should be higher than the specified role)`",
  usage: "addrole `<user mention/user id> <role name/role mention/role id>`"
};